// Switch artwork adapted from Uiverse.io by rishichawda.
export function ThemeSwitch({ dark, onToggle }: { dark: boolean; onToggle: () => void }) {
  return (
    <label id="theme-toggle-button" title="Toggle dark mode">
      <input type="checkbox" id="toggle" checked={dark} onChange={onToggle} aria-label="Toggle dark mode" />
      <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(3.5 3.5)">
          <rect fill="#83cbd8" transform="translate(0 0)" rx="17.5" height="35" width="60.667" id="container" />

          <g transform="translate(2.333 2.333)" id="button">
            <g id="sun">
              <circle fill="#f8e664" r="15.167" cy="15.167" cx="15.167" id="sun-outer" />
              <path
            ...
            <g id="moon">
              <circle fill="#cce6ee" r="15.167" cy="15.167" cx="15.167" id="moon-body" />
